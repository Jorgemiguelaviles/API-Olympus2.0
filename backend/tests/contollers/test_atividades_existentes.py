...
def test_init_controller(
    ...
    assert (
        controller.service_banco
        is not None
    )

    assert (
        controller.service_validacao
        is not None
    )
...
# ==========================================
# BUSCAR ATIVIDADES - HTTPException
# ==========================================
@patch(
    "src.contollers.controller_atividades.service_atividades"
)
def test_busca_atividades_http_exception(
    mock_service,
    db_mock
):
...
# ==========================================
# CADASTRAR ATIVIDADE - NORMALIZAÇÃO
# ==========================================
@patch(
    "src.contollers.controller_atividades.service_atividades"
)
...
def test_cadastrar_atividade_normalizacao(
    mock_validacao,
    mock_service,
    db_mock
):
